...
async function seedPureR2() {
  console.log('🚀 Sadece R2 (Masaüstü + Mobil) alanları ile Hakkımızda V2 güncelleniyor...')

  const doc = {
    _id: 'aboutPageV2',
    _type: 'aboutPageV2',
    heroImageR2: R2.hero,
    heroImageMobileR2: R2.heroMob,
    heroBadge: {
      tr: 'Birim Mimari Yaklaşım',
      en: 'Birim Architectural Approach',
    },
    heroTitle: {
      tr: 'HAKKIMIZDA',
      en: 'ABOUT US',
    ...
    heroSubtitle: {
      tr: 'Mekana ruh katan minimalist zanaat ve mimari hassasiyet.',
      en: 'Minimalist craft and architectural precision adding soul to space.',
    },
    manifestoLabel: {
      tr: 'Felsefemiz',
      en: 'Our Philosophy',
            ...
            children: [
              {
                _key: 'q-tr-1-span',
                _type: 'span',
                text: 'Modern üretim parkurumuz me usta zanaatkarlarımızın el emeği, ürettiğimiz her detayda birleşir. Sürdürülebilir hammadde kullanımı ve uzun ömürlü mühendislik anlayışıyla nesiller boyu yaşayacak mobilyalar üretiyoruz.',
              },
            ],
          },
        ],
