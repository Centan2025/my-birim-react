    ...
    await transporter.sendMail({
      ...
      html: `
        ...
        <body style="margin: 0; padding: 0; background-color: #f9fafb;">
          ...
          >
            <div style="background-color:#ffffff; padding: 32px 28px 24px 28px; border-radius: 8px; border: 1px solid #e5e7eb;">
              <p style="margin: 0 0 16px 0; font-size: 18px; font-weight: 600; letter-spacing: 0.05em; text-transform: uppercase;">
                Şifre Sıfırlama Talebi
              </p>
              <p style="margin: 0 0 14px 0;">Merhaba,</p>
              <p style="margin: 0 0 14px 0;">
                Birim hesabınızın şifresini sıfırlamak için bir talep aldık. İşleme devam etmek için aşağıdaki butona tıklayın:
              </p>
              <p style="margin: 28px 0; text-align: left;">
                <a
                  href="${resetUrl}"
