...
async function runUpdate() {
  ...
  const block0 =
    existingBlocks[0] && existingBlocks[0].mediaType !== 'panels'
      ? existingBlocks[0]
      : {
          ...
          title: {
            ...
            tr: 'BIRIM TASARIM FELSEFESİ',
            en: 'BIRIM DESIGN PHILOSOPHY',
          },
          titlePosition: 'below',
          titleFont: 'normal',
          titleAlignment: 'left',
                ...
                children: [
                  {
                    _key: 'span0',
                    _type: 'span',
                    text: "1975'ten bugüne mimari disiplin, malzeme dürüstlüğü ve usta el işçiliğinin buluştuğu zamansız tasarım koleksiyonları.",
                  },
                ],
                markDefs: [],
                style: 'normal',
          ...
          children: [
            {
              _key: 's_tau',
              _type: 'span',
              text: 'Tasarımcı Cem Tanrıkulu ve deri sanatçısı Serdar Onukar’ın imzasını taşıyan TAU; ünite ve büfe gibi farklı hacimler üzerinde kösele derinin sanatsal bir dışavurumudur. Özel boyama ve doku teknikleriyle işlenen derinin patchwork kurgusuyla kaplandığı bu seri, zanaatın modern geometrideki en yüksek ifadesini sunuyor.',
            },
          ],
          markDefs: [],
          style: 'normal',
          ...
          children: [
            {
              _key: 's_riva',
              _type: 'span',
              text: 'Zemine yakın masif silüetiyle mekanda panoramik bir konfor alanı kurgulayan Riva; farklı açı ve formlarda kurgulanabilen esnek modüler yapısı sayesinde, geniş oturum derinliğini mekanın geometrisine uyum sağlayan heykelsi bir yerleşimle buluşturuyor.',
            },
          ],
          markDefs: [],
          style: 'normal',
          ...
          children: [
            {
              _key: 's_tin',
              _type: 'span',
              text: 'Doğrusal bir metal strüktür üzerinde yükselen TIN; çekmeceli ve çekmecesiz üst tabla seçenekleriyle, fonksiyonu en yalın geometrik formda sunuyor. Keskin hatları ve rasyonel oranlarıyla mekanda mimari bir netlik sergiliyor.',
            },
          ],
          markDefs: [],
          style: 'normal',
  ...
  await client.patch(homeDoc._id).set({contentBlocks: newContentBlocks}).commit()
  ...
  if (siteSettingsDoc) {
    await client.patch(siteSettingsDoc._id).set({imageBorderStyle: 'square'}).commit()
  }
