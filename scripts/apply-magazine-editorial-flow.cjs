...
async function main() {
  ...
  const block2 = {
    ...
    title: {
      _type: 'localizedString',
      tr: 'MATERYAL VE FORM SENTETİĞİ',
      en: 'SYNTHESIS OF MATERIAL & FORM',
    },
    titlePosition: 'above',
    titleFont: 'Oswald',
    titleAlignment: 'center',
    ...
    linkText: {
      _type: 'localizedString',
      tr: 'MİMARİ SEÇKİYİ İNCELEYİN',
      en: 'DISCOVER ARCHITECTURAL SELECTION',
    },
    linkUrl: '/products',
    showButtonOnMedia: false,
  ...
  const block3 = {
    ...
    title: {
      _type: 'localizedString',
      tr: 'PANORAMİK OTURUM VE MODÜLER DOKU',
      en: 'PANORAMIC SEATING & MODULAR TEXTURE',
    },
    titlePosition: 'below',
    titleFont: 'normal',
    titleAlignment: 'left',
  ...
  const block4 = {
    ...
    title: {
      _type: 'localizedString',
      tr: 'BİRİM ATELIER: ÖZEL PROJELER VE MİMARİ DANIŞMANLIK',
      en: 'BIRIM ATELIER: CUSTOM CONTRACT & CONSULTATION',
    },
    titlePosition: 'above',
    titleFont: 'Oswald',
    titleAlignment: 'center',
  ...
  for (const doc of homeDocs) {
    ...
    await client.patch(doc._id).set({contentBlocks: magazineBlocks}).commit()
  }
