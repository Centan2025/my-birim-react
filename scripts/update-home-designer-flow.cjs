...
async function runUpdate() {
  ...
  const block0 = {
    ...
    mediaType: "image",
    position: "center",
    title: { _type: "localizedString", tr: "1975'TEN BUGÜNE MİMARİ SANAT VE DİSİPLİN", en: "ARCHITECTURAL ART & DISCIPLINE SINCE 1975" },
    titlePosition: "above",
    titleFont: "Oswald",
  ...
  const block2 = {
    ...
    mediaType: "image",
    position: "full",
    title: { _type: "localizedString", tr: "ZANAATIN ZİRVESİ: TAU KONSOL", en: "MASTER CRAFTSMANSHIP: TAU CONSOLE" },
    titlePosition: "above",
    titleFont: "normal",
    titleAlignment: "center",
  ...
  const block3 = {
    ...
    mediaType: "image",
    position: "right",
    title: { _type: "localizedString", tr: "PANORAMİK KONFOR: RİVA KANEPE", en: "PANORAMIC COMFORT: RIVA SOFA" },
    titlePosition: "below",
    titleFont: "normal",
    titleAlignment: "left",
  ...
  const block4 = {
    ...
    mediaType: "image",
    position: "left",
    title: { _type: "localizedString", tr: "MÜREKKEP SANATI VE METAL: SUR SEHPA", en: "INK ART & STAINLESS STEEL: SUR TABLE" },
    titlePosition: "below",
    titleFont: "normal",
    titleAlignment: "left",
    ...
    linkText: { _type: "localizedString", tr: "SUR KOLEKSİYONUNU KEŞFEDİN", en: "DISCOVER SUR COLLECTION" },
  ...
  const block5 = {
    ...
    mediaType: "image",
    position: "right",
    title: { _type: "localizedString", tr: "RASYONEL GEOMETRİ: TİN DRESUAR", en: "RATIONAL GEOMETRY: TIN CONSOLE" },
    titlePosition: "below",
    titleFont: "normal",
    titleAlignment: "left",
  ...
  const block6 = {
    ...
    mediaType: "image",
    position: "full",
    title: { _type: "localizedString", tr: "BİRİM ATELIER: ÖZEL PROJELER VE MİMARİ ÇÖZÜMLER", en: "BIRIM ATELIER: CUSTOM PROJECTS & ARCHITECTURAL CONSULTATION" },
    titlePosition: "above",
    titleFont: "Oswald",
    titleAlignment: "center",
    description: {
  ...
  await client.patch(homeDoc._id)
    .set({ contentBlocks: masterBlocks })
    .commit();
