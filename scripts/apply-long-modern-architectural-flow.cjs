...
async function main() {
  console.log("Applying Long Modern Architectural Narrative Flow (10 Blocks, Warm Authentic Copy)...");
  ...
  const block2 = {
    ...
    mediaType: "image",
    position: "left",
    title: { _type: "localizedString", tr: "EL İŞÇİLİĞİNİN DOKUNSAL HAKİKATI", en: "THE TACTILE TRUTH OF CRAFTSMANSHIP" },
    titlePosition: "below",
    titleFont: "normal",
    titleAlignment: "left",
    description: makeText(
  ...
  const block3 = {
    ...
    mediaType: "image",
    position: "right",
    title: { _type: "localizedString", tr: "ZEMİNE YAKIN BİR YAŞAM DİSİPLİNİ", en: "GROUNDED LIVING DISCIPLINE" },
    titlePosition: "below",
    titleFont: "normal",
    titleAlignment: "left",
    description: makeText(
  ...
  const block4 = {
    ...
    mediaType: "image",
    position: "left",
    title: { _type: "localizedString", tr: "MÜREKKEBİN ÇELİKLE DİYALOĞU", en: "THE DIALOGUE OF INK & STEEL" },
    titlePosition: "below",
    titleFont: "normal",
    titleAlignment: "left",
    description: makeText(
  ...
  const block5 = {
    ...
    mediaType: "image",
    position: "right",
    title: { _type: "localizedString", tr: "HASSAS ÇİZGİLERDE SAF GEOMETRİ", en: "PURE GEOMETRY IN LINEAR LINES" },
    titlePosition: "below",
    titleFont: "normal",
    titleAlignment: "left",
    description: makeText(
  ...
  const block6 = {
    ...
    mediaType: "image",
    position: "left",
    title: { _type: "localizedString", tr: "YUMUŞAK HATLARLA SAKİNLİK", en: "SERENITY WITH SOFT SILHOUETTES" },
    titlePosition: "below",
    titleFont: "normal",
    titleAlignment: "left",
    description: makeText(
  ...
  const block7 = {
    ...
    mediaType: "image",
    position: "right",
    title: { _type: "localizedString", tr: "İŞLEVİN HEYKELSİ SİLÜETİ", en: "THE SCULPTURAL SILHOUETTE OF FUNCTION" },
    titlePosition: "below",
    titleFont: "normal",
    titleAlignment: "left",
    description: makeText(
  ...
  const block8 = {
    ...
    mediaType: "image",
    position: "left",
    title: { _type: "localizedString", tr: "MEKÂNDA TEKİL BİR VURGU", en: "A SINGULAR ACCENT IN SPACE" },
    titlePosition: "below",
    titleFont: "normal",
    titleAlignment: "left",
    description: makeText(
    ...
    linkText: { _type: "localizedString", tr: "TEKLİ VE PUF KOLEKSİYONUNU İNCELEYİN", en: "EXPLORE ARMCHAIR & PUFF SELECTION" },
    linkUrl: "/products",
    showButtonOnMedia: false,
    backgroundColor: "gray",
    hasBorder: false,
  ...
  const longBlocks = [block0, panelBlock, block2, block3, block4, block5, block6, block7, block8, block9];

  console.log("Patching published AND draft homePage documents with 10-Block Modern Architectural Journey...");
  const homeDocs = await client.fetch(`*[_type == "homePage"]{ _id }`);
  for (const doc of homeDocs) {
    console.log(`Updating ${doc._id}...`);
    await client.patch(doc._id)
      .set({ contentBlocks: longBlocks })
      .commit();
  }
