...
async function main() {
  console.log(
    'Applying Long Modern Architectural Narrative Flow (10 Blocks, Warm Authentic Copy)...'
  )
  ...
  // BLOCK 0: MEKÂNIN SESSİZ DİLİ (Full Width)
  const block0 = {
    _key: 'arch_b0_intro',
    _type: 'contentBlock',
    order: 0,
    ...
    title: {
      ...
      tr: 'MEKÂNIN SESSİZ DİLİ VE İNSAN',
      en: 'THE SILENT LANGUAGE OF SPACE & HUMANITY',
    },
    titlePosition: 'above',
    titleFont: 'Oswald',
    ...
    description: makeText(
      ...
      'When you enter a space, the first thing you feel is not the furniture, but the silent resonance of the architecture. Since 1975, we bring together wood, metal, and leather with architectural honesty.'
    ),
    contentFont: 'normal',
    ...
    linkText: {
      _type: 'localizedString',
      tr: 'KOLEKSİYON YOLCULUĞUNA BAŞLAYIN',
      en: 'START THE COLLECTION JOURNEY',
    },
    linkUrl: '/products',
  ...
  // BLOCK 2: ZANAATIN DOKUNSAL HAKİKATI (Left Image - Tau Konsol)
  const block2 = {
    _key: 'arch_b2_tau',
    _type: 'contentBlock',
    order: 2,
    ...
    title: {
      _type: 'localizedString',
      tr: 'EL İŞÇİLİĞİNİN DOKUNSAL HAKİKATI',
      en: 'THE TACTILE TRUTH OF CRAFTSMANSHIP',
    },
    titlePosition: 'below',
    titleFont: 'normal',
    titleAlignment: 'left',
    ...
    linkText: {
      _type: 'localizedString',
      tr: 'TAU KONSOL DETAYLARINI KEŞFEDİN',
      en: 'DISCOVER TAU CONSOLE DETAILS',
    },
  ...
  // BLOCK 3: ZEMİNE YAKIN BİR YAŞAM DİSİPLİNİ (Right Image - Riva Kanepe)
  const block3 = {
    _key: 'arch_b3_riva',
    _type: 'contentBlock',
    order: 3,
    ...
    title: {
      _type: 'localizedString',
      tr: 'ZEMİNE YAKIN BİR YAŞAM DİSİPLİNİ',
      en: 'GROUNDED LIVING DISCIPLINE',
    },
    titlePosition: 'below',
    titleFont: 'normal',
    titleAlignment: 'left',
    description: makeText(
      ...
      'Riva presents a humble yet powerful presence at the center of the space with its ground-level solid silhouette. Modular architecture that embraces human ergonomics.'
    ),
    contentFont: 'normal',
    textAlignment: 'left',
    textPosition: 'below',
    ...
    linkText: {
      _type: 'localizedString',
      tr: 'RİVA OTURUM KURGUSUNU İNCELEYİN',
      en: 'EXPLORE RIVA SEATING SYSTEM',
    },
  ...
  // BLOCK 4: MÜREKKEBİN ÇELİKLE DİYALOĞU (Left Image - Sur Sehpa)
  const block4 = {
    _key: 'arch_b4_sur',
    _type: 'contentBlock',
    order: 4,
    ...
    title: {
      _type: 'localizedString',
      tr: 'MÜREKKEBİN ÇELİKLE DİYALOĞU',
      en: 'THE DIALOGUE OF INK & STEEL',
    },
    titlePosition: 'below',
    titleFont: 'normal',
    titleAlignment: 'left',
    ...
    linkText: {
      _type: 'localizedString',
      tr: 'SUR SEHPA HİKÂYESİNİ OKUYUN',
      en: 'READ SUR TABLE STORY',
    },
  ...
  // BLOCK 5: HASSAS ÇİZGİLERDE SAF GEOMETRİ (Right Image - Tin Dresuar)
  const block5 = {
    _key: 'arch_b5_tin',
    _type: 'contentBlock',
    order: 5,
    ...
    title: {
      _type: 'localizedString',
      tr: 'HASSAS ÇİZGİLERDE SAF GEOMETRİ',
      en: 'PURE GEOMETRY IN LINEAR LINES',
    },
    titlePosition: 'below',
    titleFont: 'normal',
    titleAlignment: 'left',
  ...
  // BLOCK 6: YUMUŞAK HATLARLA SAKİNLİK (Left Image - Soft Yatak)
  const block6 = {
    _key: 'arch_b6_soft',
    _type: 'contentBlock',
    order: 6,
    ...
    title: {
      _type: 'localizedString',
      tr: 'YUMUŞAK HATLARLA SAKİNLİK',
      en: 'SERENITY WITH SOFT SILHOUETTES',
    },
    titlePosition: 'below',
    titleFont: 'normal',
    titleAlignment: 'left',
    ...
    linkText: {
      _type: 'localizedString',
      tr: 'SOFT YATAK DOKULARINI İNCELEYİN',
      en: 'DISCOVER SOFT BED TEXTURES',
    },
  ...
  // BLOCK 7: İŞLEVİN HEYKELSİ SİLÜETİ (Right Image - Mes Konsol)
  const block7 = {
    _key: 'arch_b7_mes',
    _type: 'contentBlock',
    order: 7,
    ...
    title: {
      _type: 'localizedString',
      tr: 'İŞLEVİN HEYKELSİ SİLÜETİ',
      en: 'THE SCULPTURAL SILHOUETTE OF FUNCTION',
    },
    titlePosition: 'below',
    titleFont: 'normal',
    titleAlignment: 'left',
    ...
    linkText: {
      _type: 'localizedString',
      tr: 'MES KOLEKSİYONUNU KEŞFEDİN',
      en: 'EXPLORE MES COLLECTION',
    },
  ...
  // BLOCK 8: MEKÂNDA TEKİL BİR VURGU (Left Image - Bench T)
  const block8 = {
    _key: 'arch_b8_bench',
    _type: 'contentBlock',
    order: 8,
    ...
    title: {
      _type: 'localizedString',
      tr: 'MEKÂNDA TEKİL BİR VURGU',
      en: 'A SINGULAR ACCENT IN SPACE',
    },
    titlePosition: 'below',
    titleFont: 'normal',
    titleAlignment: 'left',
    description: makeText(
      'Bazen tek bir berjer ya da bench, odanın tüm karakterini değiştirir. Kişisel bir okuma köşesi veya geniş bir salonun köşe noktası... Formun bedenle kurduğu samimi temas, yaşam alanına karakter katar.',
      "Sometimes a single armchair or bench transforms an entire room's character. Intimate contact between form and body."
    ),
    contentFont: 'normal',
    textAlignment: 'left',
    textPosition: 'below',
    verticalAlignment: 'center',
    imageR2: makeR2Asset(
      'https://birim-assets.web-birim.workers.dev/migration/products/tk0243-bench/1782374343688-243.webp',
      'migration/products/tk0243-bench/1782374343688-243.webp'
    ),
    linkText: {
      _type: 'localizedString',
      tr: 'TEKLİ VE PUF KOLEKSİYONUNU İNCELEYİN',
      en: 'EXPLORE ARMCHAIR & PUFF SELECTION',
    },
    linkUrl: '/products',
    showButtonOnMedia: false,
    backgroundColor: 'gray',
  ...
  // BLOCK 9: BİRİM ATELIER VE MİMARİ İLETİŞİM (Full Width Closing)
  const block9 = {
    _key: 'arch_b9_atelier',
    _type: 'contentBlock',
    order: 9,
    mediaType: 'image',
    position: 'full',
    title: {
      _type: 'localizedString',
      tr: 'BİRİM ATELIER: SİZİN MİMARİ VİZYONUNUZ',
      en: 'BIRIM ATELIER: YOUR ARCHITECTURAL VISION',
    },
    titlePosition: 'above',
    titleFont: 'Oswald',
    titleAlignment: 'center',
    ...
    linkText: {
      _type: 'localizedString',
      tr: 'MİMARİ EKİBİMİZLE İLETİŞİME GEÇİN',
      en: 'CONTACT OUR ARCHITECTURAL TEAM',
    },
    linkUrl: '/contact',
    showButtonOnMedia: false,
    backgroundColor: 'white',
  ...
  console.log(
    'Patching published AND draft homePage documents with 10-Block Modern Architectural Journey...'
  )
  const homeDocs = await client.fetch(`*[_type == "homePage"]{ _id }`)
  for (const doc of homeDocs) {
    console.log(`Updating ${doc._id}...`)
    await client.patch(doc._id).set({contentBlocks: longBlocks}).commit()
  }

  console.log('10-Block Modern Architectural Narrative Flow applied successfully!')
}
