...
async function main() {
  console.log('Applying Symmetrical Padding Hybrid Flow...')
  ...
  // BLOCK 0: FULL-WIDTH INTRO (Always White Background)
  const block0 = {
    _key: 'bal_b0_intro',
    _type: 'contentBlock',
    order: 0,
  ...
  const block2 = {
    ...
    title: {
      _type: 'localizedString',
      tr: 'EL İŞÇİLİĞİNİN DOKUNSAL HAKİKATI: TAU KONSOL',
      en: 'THE TACTILE TRUTH OF CRAFTSMANSHIP: TAU CONSOLE',
    },
    titlePosition: 'below',
    titleFont: 'normal',
    titleAlignment: 'left',
    description: makeText(
      "Derinin her bir parçası bir ustanın hands'inde şekillenirken kendi hikâyesini anlatır. Tasarımcı Cem Tanrıkulu ve deri zanaatçısı Serdar Onukar’ın imzasını taşıyan TAU; geleneksel kösele işçiliğini modern mimarinin heykelsi oranlarıyla buluşturuyor. Dokunulduğunda zamanı yavaşlatan bir malzeme sadakati.",
  ...
  const block3 = {
    ...
    title: {
      _type: 'localizedString',
      tr: 'ZEMİNE YAKIN BİR YAŞAM DİSİPLİNİ: RİVA KANEPE',
      en: 'GROUNDED LIVING DISCIPLINE: RIVA SOFA',
    },
    titlePosition: 'below',
    titleFont: 'normal',
    titleAlignment: 'left',
  ...
  const block4 = {
    ...
    title: {
      _type: 'localizedString',
      tr: 'MÜREKKEBİN ÇELİKLE DİYALOĞU: SUR SEHPA',
      en: 'THE DIALOGUE OF INK & STEEL: SUR TABLE',
    },
    titlePosition: 'below',
    titleFont: 'normal',
    titleAlignment: 'left',
  ...
  const block5 = {
    ...
    title: {
      _type: 'localizedString',
      tr: 'HASSAS ÇİZGİLERDE SAF GEOMETRİ: TİN DRESUAR',
      en: 'PURE GEOMETRY IN LINEAR LINES: TIN CONSOLE',
    },
    titlePosition: 'below',
    titleFont: 'normal',
    titleAlignment: 'left',
  ...
  const block6 = {
    ...
    title: {
      _type: 'localizedString',
      tr: 'YUMUŞAK HATLARLA SAKİNLİK: SOFT YATAK',
      en: 'SERENITY WITH SOFT SILHOUETTES: SOFT BED',
    },
    titlePosition: 'above',
    titleFont: 'normal',
    titleAlignment: 'center',
  ...
  // BLOCK 7: MES KONSOL (Left Image / Right Text, Gray Background, Symmetrical Padding)
  const block7 = {
    _key: 'bal_b7_mes',
    _type: 'contentBlock',
    order: 7,
    ...
    title: {
      _type: 'localizedString',
      tr: 'İŞLEVİN HEYKELSİ SİLÜETİ: MES KONSOL',
      en: 'THE SCULPTURAL SILHOUETTE OF FUNCTION: MES CONSOLE',
    },
    titlePosition: 'below',
    titleFont: 'normal',
    titleAlignment: 'left',
  ...
  // BLOCK 8: BİRİM ATELIER (Full Width Closing - Always White Background)
  const block8 = {
    _key: 'bal_b8_atelier',
    _type: 'contentBlock',
    order: 8,
  ...
  console.log('Patching published AND draft homePage documents with Symmetrical Padding...')
  const homeDocs = await client.fetch(`*[_type == "homePage"]{ _id }`)
  for (const doc of homeDocs) {
    console.log(`Updating ${doc._id}...`)
    await client.patch(doc._id).set({contentBlocks: balancedBlocks}).commit()
  }

  console.log('Symmetrical Padding applied successfully!')
}
