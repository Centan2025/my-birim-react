...
async function main() {
  ...
  const block2 = {
    ...
    title: {
      _type: 'localizedString',
      tr: 'EL İŞÇİLİĞİNİN DOKUNSAL HAKİKATI: TAU',
      en: 'THE TACTILE TRUTH OF CRAFTSMANSHIP: TAU',
    },
    titlePosition: 'below',
    titleFont: 'normal',
    titleAlignment: 'left',
  ...
  const block3 = {
    ...
    title: {
      _type: 'localizedString',
      tr: 'ZEMİNE YAKIN BİR YAŞAM DİSİPLİNİ: RİVA',
      en: 'GROUNDED LIVING DISCIPLINE: RIVA',
    },
    titlePosition: 'below',
    titleFont: 'normal',
    titleAlignment: 'left',
  ...
  const block4 = {
    ...
    title: {
      _type: 'localizedString',
      tr: 'MÜREKKEBİN ÇELİKLE DİYALOĞU: SUR',
      en: 'THE DIALOGUE OF INK & STEEL: SUR',
    },
    titlePosition: 'below',
    titleFont: 'normal',
    titleAlignment: 'left',
  ...
  const block5 = {
    ...
    title: {
      _type: 'localizedString',
      tr: 'HASSAS ÇİZGİLERDE SAF GEOMETRİ: TİN',
      en: 'PURE GEOMETRY IN LINEAR LINES: TIN',
    },
    titlePosition: 'below',
    titleFont: 'normal',
    titleAlignment: 'left',
  ...
  const block7 = {
    ...
    title: {
      _type: 'localizedString',
      tr: 'BİRİM ATELIER: ÖZEL MİMARİ PROJELER VE KONTRAKT UYGULAMALAR',
  ...
  for (const doc of homeDocs) {
    ...
    await client.patch(doc._id).set({contentBlocks: curatedBlocks}).commit()
  }
