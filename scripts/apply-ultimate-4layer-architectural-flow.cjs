...
async function main() {
  ...
  const block0 = {
    ...
    linkText: {
      _type: 'localizedString',
      tr: 'MİMARİ MİRASIMIZI KEŞFEDİN',
      en: 'DISCOVER OUR ARCHITECTURAL HERITAGE',
    },
    linkUrl: '/products',
  ...
  const block3 = {
    ...
    title: {
      _type: 'localizedString',
      tr: 'PANORAMİK OTURUM KURGUSU: RİVA KANEPE',
      en: 'PANORAMIC SEATING EXPERIENCE: RIVA SOFA',
    },
    titlePosition: 'below',
    titleFont: 'normal',
    titleAlignment: 'left',
  ...
  const block4 = {
    ...
    title: {
      _type: 'localizedString',
      tr: 'SANAT VE METALLERİN SENTETİĞİ: SUR SEHPA',
      en: 'SYNTHESIS OF ART & METAL: SUR TABLE',
    },
    titlePosition: 'below',
    titleFont: 'normal',
    titleAlignment: 'left',
  ...
  const block5 = {
    ...
    title: {
      _type: 'localizedString',
      tr: 'MILANO SALONE DEL MOBILE VE KÜRESEL SERGİLER',
      en: 'MILANO SALONE DEL MOBILE & GLOBAL EXHIBITIONS',
    },
    titlePosition: 'below',
    titleFont: 'normal',
    titleAlignment: 'left',
    ...
    linkText: {
      _type: 'localizedString',
      tr: 'TASARIM HABERLERİ VE BASINI İNCELEYİN',
      en: 'EXPLORE DESIGN NEWS & PRESS',
    },
    linkUrl: '/news',
    showButtonOnMedia: false,
    backgroundColor: 'gray',
  ...
  const block6 = {
    ...
    title: {
      _type: 'localizedString',
      tr: 'BİRİM ATELIER: ÖZEL MİMARİ PROJELER VE KONTRAKT UYGULAMALARI',
      en: 'BIRIM ATELIER: CUSTOM CONTRACT & ARCHITECTURAL CONSULTATION',
    },
    titlePosition: 'above',
    titleFont: 'Oswald',
    titleAlignment: 'center',
  ...
  console.log(
    'Patching published AND draft homePage documents with 5-Layer Diverse Architectural Flow...'
  )
  const homeDocs = await client.fetch(`*[_type == "homePage"]{ _id }`)
  for (const doc of homeDocs) {
    console.log(`Updating ${doc._id}...`)
    await client.patch(doc._id).set({contentBlocks: layersFlow}).commit()
  }
