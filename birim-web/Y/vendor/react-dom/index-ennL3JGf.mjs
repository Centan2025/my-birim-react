...
var _ = (i.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = n),
  S = (i.createPortal = function (e, r) {
    var t = 2 < arguments.length && arguments[2] !== void 0 ? arguments[2] : null
    if (!r || (r.nodeType !== 1 && r.nodeType !== 9 && r.nodeType !== 11)) throw Error(l(299))
    return o(e, r, null, t)
  }),
  ...
  N = (i.preinit = function (e, r) {
    if (typeof e == 'string' && r && typeof r.as == 'string') {
      var t = r.as,
        f = u(t, r.crossOrigin),
        g = typeof r.integrity == 'string' ? r.integrity : void 0,
        d = typeof r.fetchPriority == 'string' ? r.fetchPriority : void 0
      t === 'style'
