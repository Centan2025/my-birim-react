...
export const productMaterial = defineType({
  ...
  fields: [
    ...
    defineField({ name: 'imageR2', title: 'Görsel (R2)', type: 'r2Asset' }),
  ],
})
...
export const downloadableItem = defineType({
  ...
  fields: [
    ...
    defineField({ name: 'fileR2', title: 'Dosya (R2)', type: 'r2Asset' }),
  ],
})
...
export const exclusiveContent = defineType({
  ...
  fields: [
    ...
    // Deprecated: imagesR2 array is difficult to sync
    defineField({
      name: 'imagesR2',
      title: 'Görseller (R2) - DEPRECATED',
      type: 'array',
      of: [{ type: 'r2Asset' }],
      hidden: true,
    }),
...
export const footerPartner = defineType({
  ...
  fields: [
    ...
    defineField({ name: 'logoR2', title: 'Logo (R2)', type: 'r2Asset' }),
...
export const contentBlock = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      initialValue: 'left',
      description: 'Metinlerin (başlık ve açıklama) hizalamasını belirler.',
    }),
    defineField({
      name: 'linkText',
      title: 'Link Metni',
