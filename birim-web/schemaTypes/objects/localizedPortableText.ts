    ...
    marks: {
      ...
      annotations: [
        ...
        },
        {
          name: 'fontSize',
          type: 'object',
          title: 'Metin Boyutu (Açılır Liste)',
          icon: Type,
          fields: [
            {
              name: 'size',
              ...
              options: {
                list: [
                  {title: '12px (Çok Küçük)', value: '12px'},
                  {title: '14px (Küçük)', value: '14px'},
                  {title: '16px (Normal)', value: '16px'},
                  {title: '18px (Orta)', value: '18px'},
                  {title: '20px (Büyük)', value: '20px'},
                  {title: '24px (Ekstra Büyük)', value: '24px'},
                  {title: '28px (Başlık)', value: '28px'},
                  {title: '32px (Çok Büyük Başlık)', value: '32px'},
                  {title: '36px (Dev)', value: '36px'},
                  {title: '48px (Makro)', value: '48px'},
                  {title: '64px (Mega)', value: '64px'},
                ],
              },
            },
          ],
