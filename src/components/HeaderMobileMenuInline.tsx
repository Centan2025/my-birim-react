    ...
    >
              ...
              {supportedLocales.map(langCode => {
                ...
                return (
                  <button
                    ...
                    className={`group relative px-2 py-1 text-[0.85rem] tracking-[0.2em] transition-colors duration-200 ${
                      isActive
      ...
      <nav className="px-4 sm:px-5 lg:px-6 pb-2 flex flex-col">
        <div className="flex flex-col">
            ...
            >
              <div className="pl-6 pb-2 flex flex-col">
                ...
                <NavLink
                  ...
                  style={{
                    transitionDelay: isMobileProductsMenuOpen
                      ? `${categories.length * 50}ms`
                      : '0ms',
                  }}
                >
          ...
          <NavLink
            to="/designers"
            className={`flex items-center min-h-[3rem] py-3 text-xl font-light leading-tight tracking-[0.08em] uppercase text-gray-200 hover:text-white transition-colors duration-300 border-b border-white/10 transition-transform ${
          ...
          {settings?.isFactoryVisible && (
            <NavLink
              ...
              onClick={onCloseAll}
            >
              <CrossFadeText text={t('factory') || 'Fabrika'} triggerKey={locale} />
            </NavLink>
          )}
          <NavLink
            to="/news"
