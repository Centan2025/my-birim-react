...
function WorldMapChart({countries, cities = []}: Props) {
  ...
  return (
    ...
    >
      ...
      {zoom > 1 && !isDragging && (
        <div className="absolute bottom-14 left-1/2 -translate-x-1/2 z-10 flex items-center gap-1.5 bg-white/95 text-slate-700 backdrop-blur-md rounded-full px-3 py-1 border border-slate-200 shadow-md pointer-events-none">
