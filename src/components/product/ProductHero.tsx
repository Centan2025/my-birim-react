  ...
  return (
    <header ref={heroRef} className="relative w-full hero-section">
      ...
      >
          ...
          {Array.from({length: totalHeroSlides}).map((_, index) => {
            ...
            return (
              <div
                ...
                className="w-full h-full flex items-center justify-center relative p-0 max-md:pt-20 max-md:pb-28 max-md:px-3"
                style={
                  {
        ...
        <div className="absolute top-20 md:top-24 left-0 right-0 z-40 pointer-events-none pt-4">
