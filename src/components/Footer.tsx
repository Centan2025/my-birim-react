...
export const Footer = () => {
  ...
  if (isSettingsLoading || isFooterLoading || !settings || !content) {
    return <footer className="bg-[#242424] h-20" /> // Minimal placeholder to avoid collapse
  }

  return (
    <>
      <HomeNewsletter />
      <footer className="bg-[#242424] text-gray-400" style={{position: 'relative', zIndex: 5}}>
        <div
      ...
      <div className="lg:hidden h-2 bg-[#242424]" aria-hidden="true"></div>
    </>
  )
}
