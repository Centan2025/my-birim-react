...
export const Footer = () => {
  ...
  if (isSettingsLoading || isFooterLoading || !settings || !content) {
    return <footer className="bg-[#4A4A4A] h-20" /> // Minimal placeholder to avoid collapse
  }

  return (
    <>
      <HomeNewsletter />
      <footer className="bg-[#4A4A4A] text-gray-400" style={{position: 'relative', zIndex: 5}}>
        <div
      ...
      <div className="lg:hidden h-2 bg-[#4A4A4A]" aria-hidden="true"></div>
    </>
  )
}
