          ...
          <div className="flex flex-wrap items-center gap-2.5">
            ...
            {projectProducts.length > 0 && (
              <button
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#2c2c2c] text-white border border-[#2c2c2c] text-xs uppercase tracking-widest font-semibold hover:bg-[#404040] hover:border-[#404040] transition-all cursor-pointer shadow-sm"
              >
                <svg
                  className="w-3.5 h-3.5"
                  viewBox="0 0 24 24"
