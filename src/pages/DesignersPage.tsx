...
export function DesignersPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-primary)] overflow-x-hidden pt-20 md:pt-28 lg:pt-32 pb-32">
      ...
      {/* Breadcrumb Section */}
      <div className="relative z-20 w-full max-w-[95%] md:max-w-[92%] lg:max-w-[80vw] mx-auto px-4 md:px-8 lg:px-0 py-4 md:py-6 lg:py-8 text-gray-400">
        <Breadcrumbs
