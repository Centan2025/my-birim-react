...
export function LoginPage() {
  ...
  return (
    <div className="bg-[var(--bg-secondary)] min-h-screen text-[var(--text-primary)] transition-colors duration-500 pt-20 landscape:pt-14 md:pt-28 lg:pt-32 pb-20 font-inter">
      {/* Breadcrumbs */}
