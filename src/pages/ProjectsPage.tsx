...
export function ProjectsPage() {
  ...
  return (
    <div className="bg-[var(--bg-primary)] min-h-screen animate-fade-in-up-subtle pt-20 landscape:pt-14 md:pt-28 lg:pt-32 selection:bg-primary selection:text-black">
      {/* Breadcrumb Band */}
