                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex items-center justify-center w-7 h-7 rounded-full border border-neutral-500/40 text-[var(--text-primary)] font-light text-base flex-shrink-0">
                        {isActive ? '−' : '+'}
                      </div>
                    </button>
