...
export function CategoriesPage() {
  ...
  return (
    <div className="bg-[var(--bg-secondary)] min-h-screen transition-colors duration-500 pt-20 landscape:pt-14 md:pt-24 lg:pt-24 selection:bg-primary selection:text-black">
      {/* Breadcrumb Band */}
