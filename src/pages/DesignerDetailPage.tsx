...
export function DesignerDetailPage() {
  ...
  return (
    <div
      className={`h-auto min-h-screen lg:h-screen flex flex-col bg-[var(--bg-secondary)] selection:bg-primary selection:text-black transition-colors duration-500 lg:overflow-hidden text-[var(--text-primary)] pt-20 md:pt-24 lg:pt-28 ${fromCard ? '' : 'animate-fade-in-up-subtle'}`}
    >
      {/* Breadcrumb Band */}
