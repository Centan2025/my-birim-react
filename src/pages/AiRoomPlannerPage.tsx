    ...
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center p-6 text-center bg-black text-white space-y-4">
        ...
        <p className="text-sm text-neutral-400 max-w-md">
          Bu özellik şu anda yönetim paneli üzerinden bakıma alınmıştır. Lütfen daha sonra tekrar
          deneyin.
        </p>
        <button
          onClick={() => navigate('/')}
      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="text-center space-y-4 max-w-3xl mx-auto">
          ...
          <p className="text-base sm:text-lg text-neutral-400 font-sans leading-relaxed">
            Kataloğumuzdan dilediğiniz tasarımı seçin, odanızın fotoğrafını yükleyin ve yapay
            zekanın ışık, gölge ve perspektif analiziyle mobilyayı odanızda anında görüntüleyin.
          </p>
        </div>
